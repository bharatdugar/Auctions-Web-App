...
using Auctions_Web_App.Data;
using Auctions_Web_App.Models;
using Auctions_Web_App.Data.Services;
using System.Security.Claims;

namespace Auctions_Web_App.Controllers
{
    public class ListingsController : Controller
    {
        ...
        public ListingsController(IListingService listingsService, IWebHostEnvironment webHostEnvironment,IBidsService bidsService, ICommentsService commentsService) 
        {
